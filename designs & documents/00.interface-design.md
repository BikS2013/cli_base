...
- `generate`: Generate content using LLM models
...
```
cli-tool generate prompt "Your prompt here" --profile "gpt4-standard"
cli-tool generate chat --profile "claude-opus"
```
...
- `--max-tokens`: Override max tokens for this request
...
```bash
# Generate a completion with a prompt
cli-tool generate prompt "Write a limerick about programming" --profile "gpt4-standard"

# Generate with specific parameters
cli-tool generate prompt "Explain quantum physics" --temperature 0.2 --max-tokens 500
