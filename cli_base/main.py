...
try:
    ...
    from cli_base.extensibility import get_clipboard_command, get_page_command
    HAS_LANGCHAIN = True
except ImportError:
    HAS_LANGCHAIN = False
...
if HAS_LANGCHAIN:
    ...
    cli.add_command(get_page_command)     # 'get-page' command to convert web page content
